                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form class="mt-5 mb-5 login-input" method="get" action="page-login.php">
                                    ...
                                    <button class="btn login-form__btn submit w-100" name="submit" value="submit">Sign In</button>
                                </form>
