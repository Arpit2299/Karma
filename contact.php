...
<body>
	...
	<section class="contact_area section_gap_bottom">
		<div class="container">
			<br>
			<div class="mapouter"><div class="gmap_canvas"><iframe width="1080" height="416" id="gmap_canvas" src="https://maps.google.com/maps?q=vikhroli&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://www.embedgooglemap.net"></a></div><style>.mapouter{position:relative;text-align:right;height:416px;width:1080px;}.gmap_canvas {overflow:hidden;background:none!important;height:416px;width:1080px;text-align:center}</style>
		</div>
		<br>
			<div class="row">
				<div class="col-lg-3">
					<div class="contact_info">
						<div class="info_item">
							...
							<h6>Vikhroli,Mumbai</h6>
							<p>Netmate Solution</p>
						</div>
						<div class="info_item">
							<i class="lnr lnr-phone-handset"></i>
							<h6><a href="#">9833717165/8369058277</a></h6>
							<p>Mon to Fri 9am to 6 pm</p>
						</div>
						<div class="info_item">
							<i class="lnr lnr-envelope"></i>
							<h6><a href="#">arpittripathi567@gmail.com</a></h6>
...
echo "
<script type='text/javascript'>alert('Message Submitted Successfully !!!');</script>";
}
