            ...
            <div class="tracking_box_inner">
                ...
                <form class="row tracking_form" action="#" method="post">
                    <div class="col-md-12 form-group">
                        <input type="text" class="form-control" id="order" name="orderid" placeholder="Order ID" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Order ID'" required>
                    </div>
                    <!-- <div class="col-md-12 form-group">
                        <input type="text" class="form-control" id="email" name="username" placeholder="Billing Email Address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Billing Email Address'">
                    </div> -->
                    <div class="col-md-12 form-group">
                        <button type="submit" value="submit" name="track" class="primary-btn">Track Order</button>
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
         echo "Your order Status is ".$row["status"];
    }
} else {
    echo "0 results";
}
                ...
                <div class="col-lg-4  col-md-6 col-sm-6">
                    <div class="single-footer-widget">
                        ...
                        <div class="" id="mc_embed_signup">
                            ...
                            <form target="_blank" novalidate="true" action="tracking.php"
