                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="media">
                                        <div class="d-flex">
                                            <img  <?php echo 'src="'.$row1["image"].'"';?> alt="" height="50px" weidth="50px">
                                        </div>
                                ...
                                <td>
                                    <div class="product_count">
                                        <input type="text" name="qty" id="sst" maxlength="12" value="<?php echo $quantity; ?>" title="Quantity:"
                                            class="input-text qty">
                                       
                                    </div>
                                </td>
                                <td>
                                    <h5><?php echo $tprice;?></h5>
                                </td>
                                <td>
                                    <form action="deletecart.php" method="post">
                                    <h1><button type="submit"  name="delete" value="<?php echo $productid; ?>" class="btn"  style="background-color: #87BBA2;">X</button></h1>
                                    </form>
                                </td>
                            </tr>
                            <?php 
