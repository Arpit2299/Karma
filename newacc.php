					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item submenu dropdown active">
								...
								<ul class="dropdown-menu">
									<li class="nav-item active"><a class="nav-link" href="login1.php">Login</a></li>
			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						...
						<a href="Login1.php">Login/Register</a>
					</nav>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-6">
					<div class="login_box_img">
						...
						<div class="hover">
							...
							<a class="primary-btn" href="newacc.php">Create an Account</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="login_form_inner">
						<h3>Sign in</h3>
						<form class="row login_form"  method="post" id="contactForm" action="newacc.php">
							...
							<div class="col-md-12 form-group">
								<input type="em" class="form-control" id="email" name="email" placeholder="E-mail" onfocus="this.placeholder = ''" onblur="this.placeholder = 'E-mail'" required>
							</div>
							...
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="number" name="number" placeholder="Number" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Number" required maxlength="10">
							</div>
							...
							<div class="col-md-12 form-group">
								<button type="submit"  name="submit" value="submit" class="primary-btn">Sign In</button>
...
$sql="INSERT INTO users(username,pass,email,address,mobileno)
values('$name','$password','$email','$address','$number')";

// $sql="INSERT INTO `users`(`username`, `pass`, `email`, `address`, `mobileno`) VALUES ('$name','$password','$',[value-4],[value-5],[value-6])";
